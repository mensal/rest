...
import app.core.entity.Pagamento.Companion.ultimoDia
import app.core.entity.PagamentoDiarista
import java.math.BigDecimal

//import javax.enterprise.inject.spi.CDI

class PagamentoDiaristaDAO protected constructor() : PagamentoDAO<PagamentoDiarista>() {

    fun pagoAte(ano: Int, mes: Int): BigDecimal {
        var jpql = ""
    ...
    fun devidoAte(ano: Int, mes: Int): BigDecimal {
        var jpql = ""
